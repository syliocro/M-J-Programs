# Invoice is created and added to the sqlite database.
# A PDF is also generated at the same time.
...
window.title("M&J Invoicing: Create New Invoice")
...
# [ RETURN TO VIEW INVOICES BUTTON ]
return_label = tkinter.Label(frame, text="Exit window to return to invoices.", fg="gray")
return_label.grid(row=5, column=0)
# ==========================================================================
